            ...
            <div className='lg:flex lg:gap-10 lg:px-20 justify-center max-w-[1800px] mx-auto'>
                ...
                <div id="form-container" className='lg:flex-1'>
                    ...
                    <form onSubmit={sendEmail} className='w-11/12 m-auto'>
                        ...
                        <input type="text" name="fname" id="fname" className="block transition-transform duration-300 focus:shadow-lg focus:shadow-black/20 w-full p-[10px] border-none outline-none mb-[1rem] border-b border-solid border-b-[#d2d2d2]"/>

                        <label for="email-address" className='text-left mb-[5px] block'>Email:</label>
                        <input type="email" name="email-address" id="email-address" className='block transition-transform duration-300 focus:shadow-lg focus:shadow-black/20 w-full p-[10px] border-none outline-none mb-[1rem] border-b border-solid border-b-[#d2d2d2]' />
                        ...
                        <textarea name="client-work" id="client-work" rows="4" className='w-full p-2.5 border-none mb-4 transition-transform duration-300 focus:shadow-lg focus:shadow-black/20 outline-none border-b border-solid border-b-[#d2d2d2]'></textarea>
