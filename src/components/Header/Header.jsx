            ...
            <div className="flex justify-between flex-wrap items-center mx-auto NavBar px-5 w-full">
                ...
                <div className="flex justify-between ">
                    ...
                    <div
                        ...
                        } flex-col lg:flex lg:flex-row lg:gap-4 `}
                        id="menu-container"
                        ref={menuRef}
                    >
                        <ul
                            id="menu"
                            className="flex flex-col lg:flex-row gap-2 items-center align-items-center bg-white dark:bg-slate-grey dark:text-marigold"
                        >
                            {[
                                { label: "HOME", href: "#" },
                    ...
                    >
                        <a
                            href="https://www.linkedin.com/kaku-amsalu"
                            className="inline"
                            target="_blank"
                        >
                            {isDark ? (
                                <FaLinkedin size={22} color="slate-gray" />
                            ) : (
                                <FaLinkedin size={22} />
                            )}
                        </a>
                        <a href="https://github.com/ke-kaa" target="_blank">
                            {isDark ? (
                                <FaGithub size={22} color="slate-gray" />
                            ) : (
                                <FaGithub size={22} />
                            )}
                        </a>
                        <a
                            href="https://www.linkedin.com/in/kaku-amsalu-5aa926283/"
                            target="_blank"
                        >
                            {isDark ? (
                                <FaInstagram size={22} color="slate-gray" />
                            ) : (
                                <FaInstagram size={22} />
                            )}
                        </a>
